 ...
 * User: BADASSDESKTOP$
 * Timestamp: October 26, 2016, 10:25 pm
 */
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    public $createdDateTime;			//timestamp								YES												CURRENT_TIMESTAMP													s				
    public $modifiedDateTime;			//timestamp								YES												CURRENT_TIMESTAMP		on update CURRENT_TIMESTAMP					s				
    public $text;						//varchar								YES								100																					s				
    public $integer;					//int									YES								10.0																1				i				
    public $long;						//decimal								YES								5.2																	1				d				
    public $timestamp;					//datetime								YES																													s				
    public $cannotBeNull;				//varchar								NO								45																					s				

    public $allFieldNames = array('test_pk', 'createdDateTime', 'modifiedDateTime', 'text', 'integer', 'long', 'timestamp', 'cannotBeNull');
    public $allFieldsWithoutKeys = array('createdDateTime', 'modifiedDateTime', 'text', 'integer', 'long', 'timestamp', 'cannotBeNull');
...
*/
    protected function GetTableMetaAsAssocArray(){
        $record = array(
			...
			'createdDateTime'=>				array(		"DATA_TYPE"=>'timestamp',				"IS_NULLABLE"=>1,				"COLUMN_KEY"=>'',				"MAX_LENGTH"=>0,				"IS_NUMERIC"=>0,				"FilterTypeNum"=>$this::FILTER_TYPE_STRING,		"BoolQuoteWhenPopulating"=>1,	"BOUND_PARAM_TYPE"=>'s'),		
			...
			'text'=>						array(		"DATA_TYPE"=>'varchar',					"IS_NULLABLE"=>1,				"COLUMN_KEY"=>'',				"MAX_LENGTH"=>100,				"IS_NUMERIC"=>0,				"FilterTypeNum"=>$this::FILTER_TYPE_STRING,		"BoolQuoteWhenPopulating"=>1,	"BOUND_PARAM_TYPE"=>'s'),		
			'integer'=>						array(		"DATA_TYPE"=>'int',						"IS_NULLABLE"=>1,				"COLUMN_KEY"=>'',				"MAX_LENGTH"=>10,				"IS_NUMERIC"=>1,				"FilterTypeNum"=>$this::FILTER_TYPE_INT,		"BoolQuoteWhenPopulating"=>0,	"BOUND_PARAM_TYPE"=>'i'),		
			'long'=>						array(		"DATA_TYPE"=>'decimal',					"IS_NULLABLE"=>1,				"COLUMN_KEY"=>'',				"MAX_LENGTH"=>5.2,				"IS_NUMERIC"=>1,				"FilterTypeNum"=>$this::FILTER_TYPE_FLOAT,		"BoolQuoteWhenPopulating"=>0,	"BOUND_PARAM_TYPE"=>'d'),		
			'timestamp'=>					array(		"DATA_TYPE"=>'datetime',				"IS_NULLABLE"=>1,				"COLUMN_KEY"=>'',				"MAX_LENGTH"=>0,				"IS_NUMERIC"=>0,				"FilterTypeNum"=>$this::FILTER_TYPE_STRING,		"BoolQuoteWhenPopulating"=>1,	"BOUND_PARAM_TYPE"=>'s'),		
